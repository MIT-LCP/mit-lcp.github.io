...
def file_change(File_Content):
    ...
    """
    Years = {'ALL':''} 
    # we create a dictionary for the years from 2003, that the publications were started to get recorded int he website.
    Current_Year = datetime.datetime.now().year
    for item in reversed(range(2003, Current_Year+1)):
        # We add the keys to the dictionary of years, basically we add a every year, until the current year
        Years[int(item)] = ""
